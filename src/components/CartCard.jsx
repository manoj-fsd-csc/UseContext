...
function Card() {
  ...
  return (
    <>
    <div className='bg-secondary rounded-4 text-center mb-5' style={{width:'100%',position:'sticky',top:'0',zIndex:'1',color:'white'}}>
    <div className="row mt-4">
      ...
      <div className="row mt-2 mb-4">
        ...
        <div className="col-6 text-center">
          <button className='btn btn-outline-light'>`${totalPrice}`</button>
        </div>
      </div>
    </div>
